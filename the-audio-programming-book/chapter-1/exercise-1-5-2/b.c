...
int main(int argc, char *argv[])
{
    ...
    if (argc != 3)
    {
        ...
        printf("This program outputs the frequency in Hz based on the number of notes that it's contained in one octave (temperament).");
        return 1;
    }
    notes = atoi(argv[1]);
    if (notes < 1)
    ...
    // (b). When doing a do while here Im relying that the there exists at least one intervals stored.
    do
    {
